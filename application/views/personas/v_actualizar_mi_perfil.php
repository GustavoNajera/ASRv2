...
<section>
    <div class="container">        
        ...
        <div class="row">
            <form enctype="multipart/form-data" action="<?php echo base_url(); ?>/cPersona/actualizarPerfilAccion?id=<?= $persona['id_persona'] ?>" method="post">
                <!-- Valores originales -->
                <input type="text" class="hide " name="img_org" value="<?= $persona['img'] ?>">
                <input type="text" class="hide " name="activo" value="<?= $persona['activo'] ?>">
                <input type="text" class="hide " name="rol" value="<?= $persona["id_rol"] ?>">
